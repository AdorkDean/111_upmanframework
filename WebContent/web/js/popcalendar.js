	...
	var imgDir = "../web/images/"			// directory for images ... e.g. var imgDir="/img/"
   ...
   function WeekNbr(n) {
	...
	{
		if(!/^\d{4}-(0\d|1[012])-\d{2}$/.test(vDate))
		{
			return false;
		}
		var year = parseInt(vDate.split("-")[0]);
		var month = parseInt(vDate.split("-")[1]);
		var date = parseInt(vDate.split("-")[2]);
