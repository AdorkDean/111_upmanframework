...
function onschange() {
	...
	try {
		...
		editor.document.write('<html><head><style>body,td,tr,table {font-size:12px}</style></head><body align="left" style="word-wrap: break-word; word-break: break-all;" wrap="hard">' + textObj.value + '</body></html>');
...
function initToolBar() {
	...
	tbm.id = '_toolbar';
	//font
	tbm.innerHTML += '<SELECT onchange="applyCommand(\'FontName\', this[this.selectedIndex].value);editor.focus();"> \
	...
	//font size
	tbm.innerHTML += '<SELECT onchange="applyCommand(\'fontsize\',this[this.selectedIndex].value);editor.focus();"> \
